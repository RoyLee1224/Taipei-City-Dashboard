...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:ZweeXtSuwdkQCC/NKjEt/w==$IyZbhBebPZ8OZrExA0IgZEXpRPD/mbuw8Da38o05eyE=:ogSQFXs8SPYbX10AAafb83rbNEiiue+YBAwQ9dHM8ao=';
...
1	admin	admin@gmail.com	8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918	\N	\N	\N	\N	\N	t	t	t	f	\N	2025-05-31 05:50:45.417178+00	2025-05-31 17:25:09.827419+00
\.
...
long_term	{#F65658,#F49F36,#F5C860,#9AC17C,#4CB495,#569C9A,#60819C,#2F8AB1}	{DistrictChart,ColumnChart}	間
...
cancer_incidence_by_years	{#24B0DD,#56B96D,#F8CF58,#F5AD4A,#E170A6,#ED6A45,#AF4137,#10294A}	{TimelineSeparateChart}	\N
\.
...
1	flu_hospitals_distribution	流感疫苗接種	circle	geojson	\N	\N	{\n  "fill-color": [\n    "interpolate",\n    ["linear"],\n    ["get", "hospital_count"],\n    0, "#f7f7f7",     \n    5, "#d9f2a7",     \n    10, "#addd8e",    \n    15, "#78c679",    \n    20, "#41ab5d",    \n    25, "#238443",    \n    30, "#005a32"     \n  ],\n  "fill-opacity": 0.8,\n  "fill-outline-color": "#ffffff"\n}	[\n  {\n    "key": "hospital_name",\n    "name": "hospital_name"\n  }\n]
\.
...
365	9f0f5058374b	長照機構	{2}	11mp	2025-05-31 15:45:27.867603+00	2025-05-31 15:45:27.867602+00
364	d9794b346a16	我的新儀表板	{4,3,5,1}	13mp	2025-05-31 17:15:06.011331+00	2025-05-31 12:31:00.026178+00
\.
...
SELECT pg_catalog.setval('public.dashboards_id_seq', 366, true);
