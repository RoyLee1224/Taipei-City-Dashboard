...
--
-- Name: components_translations; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.components_translations (
...
ALTER TABLE public.components_translations OWNER TO postgres;
...
--
-- Name: dashboards_translations; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.dashboards_translations (
    dashboard_id integer NOT NULL,
    language_code character varying(10) NOT NULL,
    name_translation character varying(255)
);


ALTER TABLE public.dashboards_translations OWNER TO postgres;
...
1	admin	admin@gmail.com	8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918	\N	\N	\N	\N	\N	t	t	t	f	\N	2025-05-31 05:50:45.417178+00	2025-06-01 06:35:20.315817+00
\.
...
flu_hospitals_distribution	{#24B0DD,#56B96D,#F8CF58,#F5AD4A,#E170A6,#ED6A45,#AF4137,#10294A}	{DistrictChart,ColumnChart}	家
cancer_incidence_rate	{#24B0DD,#56B96D,#F8CF58,#F5AD4A,#E170A6,#ED6A45,#AF4137,#10294A}	{TreemapChart}	人/十萬人
sports_center_visits	{#F65658,#F49F36,#F5C860,#9AC17C,#4CB495,#569C9A,#60819C,#2F8AB1}	{DistrictChart,ColumnChart}	萬人次
death_rate_taipei_by_cause_and_year	{#F65658,#F49F36,#F5C860,#9AC17C,#4CB495,#569C9A,#60819C,#2F8AB1}	{BarPercentChart,ColumnChart,PolarAreaChart}	人/十萬人
long_term	{#9DC56E,#356340,#9DC56E}	{DistrictChart,ColumnChart}	間
cancer_incidence_by_years	{#24B0DD,#56B96D,#F8CF58,#F5AD4A,#E170A6,#ED6A45,#AF4137,#10294A}	{ColumnChart}	人/十萬人
\.
...
1	flu_hospitals_tpe	流感疫苗接種	circle	geojson	big	\N	{"circle-color": "#5B8ED9"}\n	[\n  { "key": "id",                     "name": "ID" },\n  { "key": "district",              "name": "行政區代碼" },\n  { "key": "hospital_name",         "name": "醫療院所名稱" },\n  { "key": "bcg_vaccine",           "name": "卡介苗 (BCG)" },\n  { "key": "routine_child_vaccine", "name": "常規幼兒疫苗" },\n  { "key": "child_flu_under3",      "name": "幼兒流感疫苗 (3歲以下)" },\n  { "key": "child_flu_over3",       "name": "幼兒流感疫苗 (3歲以上)" },\n  { "key": "adult_flu",             "name": "成人流感疫苗" },\n  { "key": "covid19",               "name": "COVID-19 疫苗" },\n  { "key": "pneumococcal",          "name": "肺炎鏈球菌疫苗" },\n  { "key": "rotavirus",             "name": "輪狀病毒疫苗" },\n  { "key": "mpox",                  "name": "猴痘疫苗" },\n  { "key": "enterovirus",           "name": "腸病毒疫苗" },\n  { "key": "address",               "name": "地址" },\n  { "key": "phone",                 "name": "電話" },\n  { "key": "voice_reservation",     "name": "語音預約 (0=否,1=是)" }\n]\n
2	flu_hospitals_metrotaipei	流感疫苗接種	circle	geojson	big	\N	{"circle-color": "#5B8ED9"}	[\n  { "key": "id",               "name": "ID" },\n  { "key": "institution_code", "name": "醫事機構代碼" },\n  { "key": "name",             "name": "醫療院所名稱" },\n  { "key": "tel",              "name": "電話" },\n  { "key": "address",          "name": "地址" },\n  { "key": "type",             "name": "機構類型" },\n  { "key": "remark",           "name": "備註" },\n  { "key": "reservation",      "name": "預約方式" },\n  { "key": "own_expense",      "name": "自費接種" },\n  { "key": "division",         "name": "科別" },\n  { "key": "notice",           "name": "注意事項" }\n]
\.
...
1	flu_hospitals_distribution	各行政區流感疫苗接種醫院數量統計
2	long_term	長照據點
3	sports_center_visits	各行政區運動場館使用次數
4	cancer_incidence_rate	十大癌症發生率
5	cancer_incidence_by_years	各種癌症每年發生機率
6	death_rate_taipei_by_cause_and_year	死因別死亡率總覽
\.


--
-- Data for Name: components_translations; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.components_translations (component_id, language_code, name_translation) FROM stdin;
1	en-US	Number of Flu Vaccination Hospitals by District
2	en-US	Long-term Care Service Spots
3	en-US	Sports Center Visits by District
4	en-US	Top 10 Cancer Incidence Rates
5	en-US	Annual Incidence Rate of Various Cancers
6	en-US	Overview of Mortality Rates by Cause of Death
60	en-US	YouBike Availability Status
212	en-US	Electric Bus Proportion
213	en-US	Cycling Path Statistics
214	en-US	Dependency Ratio and Aging Index
215	en-US	Age Structure Trend of the Employed Elderly Population
216	en-US	City-wide Age Distribution
217	en-US	Cycling Route Network Map Data
218	en-US	Long-term Care Indicators
\.
...
360	2fba1e4945a9	收藏組件	\N	favorite	2025-05-31 05:50:45.425078+00	2025-05-31 05:50:45.425078+00
364	d9794b346a16	健康守護	{6,4,5,3,1,2}	healing	2025-06-01 00:40:45.436676+00	2025-05-31 12:31:00.026178+00
\.


--
-- Data for Name: dashboards_translations; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.dashboards_translations (dashboard_id, language_code, name_translation) FROM stdin;
1	en-US	Favorite Components
2	en-US	My New Dashboard
106	en-US	Map Info
355	en-US	Long-term Care
356	en-US	Long-term Care
358	en-US	Transportation
359	en-US	Map Info
360	en-US	Favorite Components
364	en-US	Health Guard
\.
...
flu_hospitals_distribution	\N	{1,2}	\N	static	\N	\N	\N	衛生局	顯示雙北各行政區流感疫苗接種醫院數量分布	此圖表呈現台北市和新北市各行政區流感疫苗接種醫院數量分布情況，幫助了解各區域醫療資源的配置狀況。	可用於評估各行政區流感疫苗接種醫療資源的充足性，協助規劃疫苗接種點的增設與分配，提升公共衛生服務覆蓋率。	{https://data.taipei/dataset/detail?id=ec201f0a-2efa-4426-9439-a8daea7b33c7&utm_source=chatgpt.com,https://data.ntpc.gov.tw/datasets/551cd3f4-534a-45cf-976a-359090fb7df6}	{doit}	2025-05-31 12:26:30.81015+00	2025-05-31 13:00:25.8969+00	two_d	WITH predefined_districts AS (\n        SELECT district_name, ordinality\n        FROM unnest(ARRAY[\n            '北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區', '中正區', '萬華區', '大安區', '文山區',\n            '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '蘆洲區', '中和區', '永和區', '新店區',\n            '鶯歌區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', '石碇區', '坪林區', '三芝區', '石門區',\n            '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'\n        ]) WITH ORDINALITY AS t(district_name, ordinality)\n    ),\n    taipei_district_mapping AS (\n        SELECT district_code, district_name FROM (VALUES\n            ('63000010', '松山區'),\n            ('63000020', '信義區'), \n            ('63000030', '大安區'),\n            ('63000040', '中山區'),\n            ('63000050', '中正區'),\n            ('63000060', '大同區'),\n            ('63000070', '萬華區'),\n            ('63000080', '文山區'),\n            ('63000090', '南港區'),\n            ('63000100', '內湖區'),\n            ('63000110', '士林區'),\n            ('63000120', '北投區')\n        ) AS t(district_code, district_name)\n    ),\n    new_taipei_districts AS (\n        SELECT \n            id,\n            name,\n            CASE \n                WHEN address LIKE '%八里區%' THEN '八里區'\n                WHEN address LIKE '%三芝區%' THEN '三芝區'\n                WHEN address LIKE '%石門區%' THEN '石門區'\n                WHEN address LIKE '%三重區%' THEN '三重區'\n                WHEN address LIKE '%新莊區%' THEN '新莊區'\n                WHEN address LIKE '%泰山區%' THEN '泰山區'\n                WHEN address LIKE '%林口區%' THEN '林口區'\n                WHEN address LIKE '%蘆洲區%' THEN '蘆洲區'\n                WHEN address LIKE '%五股區%' THEN '五股區'\n                WHEN address LIKE '%板橋區%' THEN '板橋區'\n                WHEN address LIKE '%土城區%' THEN '土城區'\n                WHEN address LIKE '%樹林區%' THEN '樹林區'\n                WHEN address LIKE '%鶯歌區%' THEN '鶯歌區'\n                WHEN address LIKE '%三峽區%' THEN '三峽區'\n                WHEN address LIKE '%中和區%' THEN '中和區'\n                WHEN address LIKE '%永和區%' THEN '永和區'\n                WHEN address LIKE '%新店區%' THEN '新店區'\n                WHEN address LIKE '%深坑區%' THEN '深坑區'\n                WHEN address LIKE '%石碇區%' THEN '石碇區'\n                WHEN address LIKE '%坪林區%' THEN '坪林區'\n                WHEN address LIKE '%烏來區%' THEN '烏來區'\n                WHEN address LIKE '%淡水區%' THEN '淡水區'\n                WHEN address LIKE '%汐止區%' THEN '汐止區'\n                WHEN address LIKE '%瑞芳區%' THEN '瑞芳區'\n                WHEN address LIKE '%金山區%' THEN '金山區'\n                WHEN address LIKE '%萬里區%' THEN '萬里區'\n                WHEN address LIKE '%平溪區%' THEN '平溪區'\n                WHEN address LIKE '%雙溪區%' THEN '雙溪區'\n                WHEN address LIKE '%貢寮區%' THEN '貢寮區'\n                ELSE NULL\n            END AS district_name\n        FROM flu_hospitals_new_tpe\n        WHERE address IS NOT NULL\n    ),\n    flu_hospitals_by_district AS (\n        SELECT\n            district_name,\n            COUNT(*) AS hospital_count\n        FROM (\n            SELECT tdm.district_name\n            FROM flu_hospitals_tpe ft\n            INNER JOIN taipei_district_mapping tdm ON ft.district = tdm.district_code\n            \n            UNION ALL\n            \n            SELECT district_name\n            FROM new_taipei_districts\n            WHERE district_name IS NOT NULL\n        ) combined_hospitals\n        GROUP BY district_name\n    ),\n    ordered_district_data AS (\n        SELECT\n            pd.district_name AS x_axis,\n            COALESCE(fhd.hospital_count, 0) AS data,\n            pd.ordinality\n        FROM\n            predefined_districts pd\n        LEFT JOIN\n            flu_hospitals_by_district fhd ON pd.district_name = fhd.district_name\n    )\n    SELECT\n        x_axis,\n        data\n    FROM\n        ordered_district_data\n    ORDER BY\n        ordinality	\N	metrotaipei
long_term	\N	{}	\N	static	\N	\N	\N	臺北市資料大平台、新北市政府資料開放平臺	台北市與新北市各行政區長期照顧機構分布	此圖表呈現台北市與新北市各行政區的長期照顧機構數量分布，包括老人安養及長期照顧中心、護理之家等機構，幫助了解兩城市長期照顧資源的區域配置狀況。	可用於評估台北市與新北市各行政區長期照顧機構的充足性與分布均衡性，協助規劃長期照顧服務的資源配置與擴展。	{https://data.taipei/dataset/detail?id=d10a3309-01f9-4180-88d2-c4e6ee18b640,https://data.taipei/dataset/detail?id=6ab66246-7a52-4dc2-9c72-5fbf62003e90}	{doit}	2025-05-31 15:40:16.876385+00	2025-05-31 15:40:16.876385+00	two_d	\nWITH predefined_districts AS (\n    SELECT district_name AS 行政區, ordinality\n    FROM unnest(ARRAY[\n        '北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區', '中正區', '萬華區', \n        '大安區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '蘆洲區', \n        '中和區', '永和區', '新店區', '鶯歌區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', \n        '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'\n    ]) WITH ORDINALITY AS t(district_name, ordinality)\n),\nfacility_by_district AS (\n    SELECT \n        行政區,\n        COUNT(*) AS facility_count\n    FROM \n        longterm_care_facilities\n    WHERE \n        城市 IN ('台北市')\n        AND 行政區 != ''\n    GROUP BY \n        行政區\n),\nordered_district_data AS (\n    SELECT \n        pd.行政區 AS x_axis,\n        COALESCE(fbd.facility_count, 0) AS data,\n        pd.ordinality\n    FROM \n        predefined_districts pd\n    LEFT JOIN \n        facility_by_district fbd ON pd.行政區 = fbd.行政區\n)\nSELECT \n    x_axis,\n    data\nFROM \n    ordered_district_data\nORDER BY \n    ordinality\n	\N	taipei
flu_hospitals_distribution	\N	{1}	\N	static	\N	\N	\N	衛生局	顯示雙北各行政區流感疫苗接種醫院數量分布	此圖表呈現台北市和新北市各行政區流感疫苗接種醫院數量分布情況，幫助了解各區域醫療資源的配置狀況。	可用於評估各行政區流感疫苗接種醫療資源的充足性，協助規劃疫苗接種點的增設與分配，提升公共衛生服務覆蓋率。	{https://data.taipei/dataset/detail?id=ec201f0a-2efa-4426-9439-a8daea7b33c7&utm_source=chatgpt.com,https://data.ntpc.gov.tw/datasets/551cd3f4-534a-45cf-976a-359090fb7df6}	{doit}	2025-05-31 12:29:42.154977+00	2025-05-31 13:00:25.8969+00	two_d	\nWITH predefined_districts AS (\n    SELECT district_name, ordinality\n    FROM unnest(ARRAY[\n        '北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區', '中正區', '萬華區', '大安區', '文山區'\n    ]) WITH ORDINALITY AS t(district_name, ordinality)\n),\ntaipei_district_mapping AS (\n    SELECT district_code, district_name FROM (VALUES\n        ('63000010', '松山區'),\n        ('63000020', '信義區'), \n        ('63000030', '大安區'),\n        ('63000040', '中山區'),\n        ('63000050', '中正區'),\n        ('63000060', '大同區'),\n        ('63000070', '萬華區'),\n        ('63000080', '文山區'),\n        ('63000090', '南港區'),\n        ('63000100', '內湖區'),\n        ('63000110', '士林區'),\n        ('63000120', '北投區')\n    ) AS t(district_code, district_name)\n),\nflu_hospitals_by_district AS (\n    SELECT\n        tdm.district_name,\n        COUNT(*) AS hospital_count\n    FROM flu_hospitals_tpe ft\n    INNER JOIN taipei_district_mapping tdm ON ft.district = tdm.district_code\n    GROUP BY tdm.district_name\n),\nordered_district_data AS (\n    SELECT\n        pd.district_name AS x_axis,\n        COALESCE(fhd.hospital_count, 0) AS data,\n        pd.ordinality\n    FROM\n        predefined_districts pd\n    LEFT JOIN\n        flu_hospitals_by_district fhd ON pd.district_name = fhd.district_name\n)\nSELECT\n    x_axis,\n    data\nFROM\n    ordered_district_data\nORDER BY\n    ordinality\n	\N	taipei
sports_center_visits	\N	{}	\N	static	\N	\N	\N	新北市統計資訊網	顯示雙北各運動場館使用人次分布	此圖表呈現新北市體育場館如板橋第一運動場、新莊體育園區等的使用人次分布情況。	可用於分析各體育場館的使用熱度，協助未來場地規劃與資源分配。	{https://oas.bas.ntpc.gov.tw/NTPCTRWD/NewPage/Publish.aspx?Mid1=382390000E}	{doit}	2025-05-31 17:03:59.158707+00	2025-05-31 17:03:59.158707+00	two_d	\n    WITH combined AS (\n        SELECT "區域別", "使用次數"\n        FROM public.sports_center_visits_tpe\n        WHERE "年度" = 113\n\n        UNION ALL\n\n        SELECT "區域別", "使用次數"\n        FROM public.sports_center_visits_new_tpe\n        WHERE "年度" = 113\n    )\n    SELECT\n        "區域別" AS x_axis,\n        ROUND(SUM("使用次數")::numeric / 10000, 1) AS data\n    FROM\n        combined\n    GROUP BY\n        "區域別"\n    ORDER BY\n        data DESC\n    	\N	metrotaipei
cancer_incidence_rate	\N	{}	\N	static	\N	\N	\N	衛福部	顯示臺北市各種癌症發生率	此圖表呈現臺北市各種癌症發生率情況。	可用於分析各體育場館的使用熱度，協助未來場地規劃與資源分配。	{https://data.gov.tw/dataset/6399}	{doit}	2025-05-31 17:03:31.514264+00	2025-05-31 17:03:31.514264+00	two_d	SELECT   \n    癌症別 as x_axis,  \n    ROUND(發生率) as data  \n    FROM cancer_incidence_rate_tpe\n    WHERE 癌症診斷年 = 2022   \n        AND 性別 = '全'   \n        AND 縣市別 = '台北市'  \n    ORDER BY ROUND(發生率) DESC	\N	taipei
cancer_incidence_rate	\N	{}	\N	static	\N	\N	\N	雙北市統計資料彙整	雙北市癌症別發生率平均	此圖表呈現 2022 年台北市與新北市癌症別發生率的平均值。	可用於觀察雙北市民主要癌症類型的發生情況及趨勢。	{https://data.gov.tw/dataset/6399}	{doit}	2025-05-31 17:03:39.629394+00	2025-05-31 17:03:39.629394+00	two_d	WITH combined AS (\n        SELECT 癌症別, 發生率\n        FROM cancer_incidence_rate_tpe\n        WHERE 癌症診斷年 = 2022 AND 性別 = '全'\n\n        UNION ALL\n\n        SELECT 癌症別, 發生率\n        FROM cancer_incidence_rate_new_tpe\n        WHERE 癌症診斷年 = 2022 AND 性別 = '全'\n    )\n    SELECT\n        癌症別 AS x_axis,\n        ROUND(AVG(發生率), 0) AS data\n    FROM combined\n    GROUP BY 癌症別\n    ORDER BY data DESC	\N	metrotaipei
sports_center_visits	\N	{}	\N	static	\N	\N	\N	臺北市資料大平台	顯示雙北各運動場館使用人次分布	此圖表呈現臺北市體育場館使用人次分布情況。	可用於分析各體育場館的使用熱度，協助未來場地規劃與資源分配。	{https://data.taipei/dataset/detail?id=1562240c-4e54-467f-8a1d-a3c06833e1d5}	{doit}	2025-05-31 17:04:07.654799+00	2025-05-31 17:04:07.654799+00	two_d	SELECT\n        "區域別" AS x_axis,\n        ROUND(SUM("使用次數")::numeric / 10000, 1) AS data\n    FROM\n        public.sports_center_visits_tpe\n    WHERE\n        "年度" = 113\n    GROUP BY\n        "區域別"\n    ORDER BY\n        data DESC	\N	taipei
death_rate_taipei_by_cause_and_year	\N	{}	\N	static	\N	\N	\N	臺北市資料大平台、新北市政府資料開放平臺	死因別死亡率總覽	此圖表呈現歷年不同死因別的死亡率變化情況，幫助政策制定者掌握健康趨勢與資源配置方向。	用於健康政策規劃、民眾健康風險溝通、死因結構分析。	{https://data.taipei/dataset/detail?id=0393f306-9248-4316-8f8a-2014b5e30728,https://data.ntpc.gov.tw/datasets/5e6a672a-09e6-4119-8de6-0ca9856f3a01}	{doit}	2025-05-31 18:25:30.788887+00	2025-05-31 18:25:30.788887+00	three_d	\nWITH death_data AS (\nSELECT\nCAST("年" AS TEXT) AS year,\n"死因別" AS cause_of_death,\nCAST("臺北市死亡人數" AS INT) AS deaths_taipei,\nCAST("臺北市死亡率" AS INT) AS death_rate_taipei\nFROM\npublic.mortality_stats_taipei\n)\nSELECT\nyear AS x_axis,\ncause_of_death AS y_axis,\ndeath_rate_taipei AS data\nFROM\ndeath_data\nWHERE\ncause_of_death != '總計'\nORDER BY\nyear DESC, cause_of_death\n	\N	taipei
death_rate_taipei_by_cause_and_year	\N	{}	\N	static	\N	\N	\N	臺北市資料大平台、新北市政府資料開放平臺	死因別死亡率總覽	此圖表呈現歷年不同死因別的死亡率變化情況，幫助政策制定者掌握健康趨勢與資源配置方向。	用於健康政策規劃、民眾健康風險溝通、死因結構分析。	{https://data.taipei/dataset/detail?id=0393f306-9248-4316-8f8a-2014b5e30728,https://data.ntpc.gov.tw/datasets/5e6a672a-09e6-4119-8de6-0ca9856f3a01}	{doit}	2025-05-31 18:26:12.174201+00	2025-05-31 18:26:12.174201+00	three_d	\nWITH death_data AS (\nSELECT\nCAST("年" AS TEXT) AS year,\n"死因別" AS cause_of_death,\nCAST("雙北死亡人數" AS INT) AS deaths_taipei,\nCAST("雙北死亡率" AS INT) AS death_rate_taipei\nFROM\npublic.mortality_stats_metro_taipei\n)\nSELECT\nyear AS x_axis,\ncause_of_death AS y_axis,\ndeath_rate_taipei AS data\nFROM\ndeath_data\nWHERE\ncause_of_death != '總計'\nORDER BY\nyear DESC, cause_of_death\n	\N	metrotaipei
cancer_incidence_by_years	\N	{}	\N	static	\N	\N	\N	政府資料開放平台	顯示臺北市各種癌症發生率	此圖表呈現臺北市各種癌症發生率情況。	可用於觀察臺北市民主要癌症類型的發生情況及趨勢。	{https://data.gov.tw/dataset/6399}	{doit}	2025-05-31 18:37:47.911475+00	2025-05-31 18:37:47.911475+00	three_d	SELECT\n        癌症診斷年 AS x_axis,\n        癌症別 AS y_axis,\n        ROUND(發生率)::int AS data\n    FROM cancer_incidence_rate_tpe\n    WHERE 性別 = '全'\n    AND 縣市別 = '台北市'\n    AND 癌症別 IN (\n        '口腔癌',\n        '食道癌',\n        '胃癌',\n        '大腸癌',\n        '肝癌',\n        '肺癌',\n        '皮膚癌',\n        '甲狀腺癌',\n        '白血病',\n        '淋巴癌'\n    )\n    ORDER BY 癌症診斷年, 癌症別	\N	taipei
cancer_incidence_by_years	\N	{}	\N	static	\N	\N	\N	政府資料開放平台	雙北市癌症別發生率平均	此圖表呈現 2022 年台北市與新北市癌症別發生率的平均值。	可用於觀察臺北市民主要癌症類型的發生情況及趨勢。	{https://data.gov.tw/dataset/6399}	{doit}	2025-05-31 18:37:42.146298+00	2025-05-31 18:37:42.146298+00	three_d	\n    SELECT\n        癌症診斷年 AS x_axis,\n        癌症別 AS y_axis,\n        ROUND(AVG(發生率))::int AS data\n    FROM (\n        SELECT 癌症診斷年, 癌症別, 發生率\n        FROM cancer_incidence_rate_tpe\n        WHERE 性別 = '全'\n        AND 癌症別 IN (\n            '口腔癌',\n            '食道癌',\n            '胃癌',\n            '大腸癌',\n            '肝癌',\n            '肺癌',\n            '皮膚癌',\n            '甲狀腺癌',\n            '白血病',\n            '淋巴癌'\n        )\n        UNION ALL\n        SELECT 癌症診斷年, 癌症別, 發生率\n        FROM cancer_incidence_rate_new_tpe\n        WHERE 性別 = '全'\n        AND 癌症別 IN (\n            '口咽癌',\n            '食道癌',\n            '胃癌',\n            '大腸癌',\n            '肝癌',\n            '肺癌',\n            '皮膚癌',\n            '甲狀腺癌',\n            '白血病',\n            '淋巴癌'\n        )\n    ) AS combined\n    GROUP BY 癌症診斷年, 癌症別\n    ORDER BY 癌症診斷年, 癌症別\n    	\N	metrotaipei
long_term	\N	{}	\N	static	\N	\N	\N	臺北市資料大平台、新北市政府資料開放平臺	台北市與新北市各行政區長期照顧機構分布	此圖表呈現台北市與新北市各行政區的長期照顧機構數量分布，包括老人安養及長期照顧中心、護理之家等機構，幫助了解兩城市長期照顧資源的區域配置狀況。	可用於評估台北市與新北市各行政區長期照顧機構的充足性與分布均衡性，協助規劃長期照顧服務的資源配置與擴展。	{https://data.ntpc.gov.tw/datasets/a0323809-1c7b-42f3-8dea-2b14f40118f7}	{doit}	2025-05-31 15:40:24.766078+00	2025-05-31 15:40:24.766078+00	two_d	WITH predefined_districts AS (\n    SELECT district_name AS 行政區, ordinality\n    FROM unnest(ARRAY[\n        '北投區', '士林區', '內湖區', '南港區', '松山區', '信義區', '中山區', '大同區', '中正區', '萬華區', \n        '大安區', '文山區', '新莊區', '淡水區', '汐止區', '板橋區', '三重區', '樹林區', '土城區', '蘆洲區', \n        '中和區', '永和區', '新店區', '鶯歌區', '三峽區', '瑞芳區', '五股區', '泰山區', '林口區', '深坑區', \n        '石碇區', '坪林區', '三芝區', '石門區', '八里區', '平溪區', '雙溪區', '貢寮區', '金山區', '萬里區', '烏來區'\n    ]) WITH ORDINALITY AS t(district_name, ordinality)\n),\nfacility_by_district AS (\n    SELECT \n        行政區,\n        COUNT(*) AS facility_count\n    FROM \n        longterm_care_facilities\n    WHERE \n        城市 IN ('台北市', '新北市')\n        AND 行政區 != ''\n    GROUP BY \n        行政區\n),\nordered_district_data AS (\n    SELECT \n        pd.行政區 AS x_axis,\n        COALESCE(fbd.facility_count, 0) AS data,\n        pd.ordinality\n    FROM \n        predefined_districts pd\n    LEFT JOIN \n        facility_by_district fbd ON pd.行政區 = fbd.行政區\n)\nSELECT \n    x_axis,\n    data\nFROM \n    ordered_district_data\nORDER BY \n    ordinality	\N	metrotaipei
\.
...
SELECT pg_catalog.setval('public.dashboards_id_seq', 367, true);
...
--
-- Name: components_translations components_translations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.components_translations
    ADD CONSTRAINT components_translations_pkey PRIMARY KEY (component_id, language_code);
...
--
-- Name: dashboards_translations dashboards_translations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dashboards_translations
    ADD CONSTRAINT dashboards_translations_pkey PRIMARY KEY (dashboard_id, language_code);
...
--
-- Name: idx_ct_lang; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_ct_lang ON public.components_translations USING btree (language_code);


--
-- Name: idx_dt_lang; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_dt_lang ON public.dashboards_translations USING btree (language_code);


--
-- Name: components_translations components_translations_component_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.components_translations
    ADD CONSTRAINT components_translations_component_id_fkey FOREIGN KEY (component_id) REFERENCES public.components(id) ON DELETE CASCADE;


--
-- Name: dashboards_translations dashboards_translations_dashboard_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dashboards_translations
    ADD CONSTRAINT dashboards_translations_dashboard_id_fkey FOREIGN KEY (dashboard_id) REFERENCES public.dashboards(id) ON DELETE CASCADE;
